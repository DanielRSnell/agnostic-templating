...
if ( ! class_exists( 'Agnostic_Widget' ) ) {

  class Agnostic_Widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'agnostic-template';

  	public function __construct() {

  		parent::__construct(
  			$this->get_widget_slug(),
  			__( 'Agnostic Template', $this->get_widget_slug() ),
  			array(
  	...
  	public function widget( $args, $instance ) {
  		...
  		$widget_string .= agnostic_shortcode( array( 'id' => $instance['template_id'] ), '', NULL );
...
add_action( 'widgets_init', function() { register_widget("Agnostic_Widget"); } );
