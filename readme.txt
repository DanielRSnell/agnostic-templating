...
1. Copy and past the GitHub repository uri (which is[http://github.com/pierreminik/agnostic-templates](http://github.com/pierreminik/agnostic-templates)).
...
**1.4.3**
Open sourced the premium version of the plugin and merged into Agnostic Templates.
